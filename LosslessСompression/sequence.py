...
original_sequences = [sequence1, sequence3, sequence4,
...
row = ['Послідовність 1', 'Послідовність 3', 'Послідовність 4',
